...
enum StylePart {
  ...
  BtnMatrixBG = Mix | Background | Padding | Margin | Border,
  ...
  GaugeMAIN = Background | Text | Line | Scale | Border | Padding | Margin,
  ...
  LinemeterMAIN = Background | Scale | Border | Mix | Padding | Margin,
  ...
  SpinboxCURSOR = Text,
  TableBG = Mix | Border | Padding | Margin | Text | Outline | Line,
