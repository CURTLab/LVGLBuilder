...
class LVGLPropertyMin : public LVGLPropertyInt {
 public:
  inline LVGLPropertyMin(LVGLProperty *p)
      : LVGLPropertyInt(INT16_MIN, INT16_MAX, p) {}
  inline QString name() const override { return QObject::tr("Min"); }
  inline QString codename() const override { return "Min"; }

  inline int get(LVGLObject *obj) const override {
    const LVGLPropertyRange *r =
        reinterpret_cast<const LVGLPropertyRange *>(m_parent);
    return r->getMin(obj);
  }
  inline void set(LVGLObject *obj, int value) override {
    LVGLPropertyRange *r = reinterpret_cast<LVGLPropertyRange *>(
        const_cast<LVGLProperty *>(m_parent));
...
class LVGLPropertyMax : public LVGLPropertyInt {
 public:
  inline LVGLPropertyMax(LVGLProperty *p)
      : LVGLPropertyInt(INT16_MIN, INT16_MAX, p) {}
  inline QString name() const override { return QObject::tr("Max"); }
  inline QString codename() const override { return "Max"; }
...
QString LVGLPropertyRange::name() const { return QObject::tr("Range"); }

QString LVGLPropertyRange::codename() const { return "Range"; }
...
QJsonValue LVGLPropertyRange::toJson(LVGLObject *obj) const {
  return QJsonObject({{"min", getMin(obj)}, {"max", getMax(obj)}});
}
